---
layout: post
title: meta标签中的viewport详细了解
categories: [blog ]
tags: [viewport ]
description: meta标签中的viewport详细了解
---
...
![](../img/uploads/2016/01/viewport1.png)
...
![](../img/uploads/2016/01/viewport2.png)
...
![](../img/uploads/2016/01/viewport3.png)

![](../img/uploads/2016/01/viewport4.png)
...
![](../img/uploads/2016/01/viewport5.png)

![](../img/uploads/2016/01/viewport6.png)
...
此外，在安卓中还支持  target-densitydpi这个私有属性，它表示目标设备的密度等级，作用是决定css中的1px代表多少物理像素

target-densitydpi 	值可以为一个数值或 high-dpi 、 medium-dpi、 low-dpi、 device-dpi 这几个字符串中的一个特别说明的是，当 target-densitydpi=device-dpi 时， css中的1px会等于物理像素中的1px。
...
![](../img/uploads/2016/01/viewport7.png)
...
![](../img/uploads/2016/01/viewport8.png)
...
![](../img/uploads/2016/01/viewport9.png)

![](../img/uploads/2016/01/viewport10.png)

![](../img/uploads/2016/01/viewport11.png)
